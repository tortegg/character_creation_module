"""Данный модуль позволяет нам созать персонажа,
выбрать его класс и попробовать использовать навыки.
"""
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция проверки действия тренировки."""
    if char_class == 'warrior':
